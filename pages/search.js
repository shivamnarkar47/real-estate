...
import noresult from '../assets/images/noresul.svg'
...
const Search = ({properties})=>{
    ...
    return(
        <Box>
            ...
            {properties.length === 0 &&(
                <Flex flexWrap="wrap" alignItems="center" justifyContent="center" flexDirection="column" marginTop="5" marginBottom="5">
